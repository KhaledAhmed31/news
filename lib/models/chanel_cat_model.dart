class ChanelsModel {
  ...
  ChanelsModel({this.status, this.sources});

  ChanelsModel.fromJson(Map<String, dynamic> json) {
    status = json["status"];
  ...
  static List<ChanelsModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(ChanelsModel.fromJson).toList();
  }
